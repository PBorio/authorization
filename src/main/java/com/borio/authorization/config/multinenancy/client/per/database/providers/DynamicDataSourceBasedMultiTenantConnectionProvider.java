package com.borio.authorization.config.multinenancy.client.per.database.providers;

import com.borio.authorization.config.multinenancy.client.per.database.exceptions.TenantNotFoundException;
...
public class DynamicDataSourceBasedMultiTenantConnectionProvider
    ...
    protected DataSource selectDataSource(String tenantIdentifier) {
        try {
            ...
            throw new TenantNotFoundException("Failed to load DataSource for tenant: " + tenantIdentifier);
        }
    }
